...
*git-friendly* is a collection of shell scripts for making **pulling**, **branching**, and **merging** fast and painless.

Git is great, but often requires typing 2 or 3 commands to execute common tasks. This package adds some new commands:
**pull, push, branch, merge** -- which are just wrappers around normal git commands and a few handy callbacks.

Bonus niceties include:
...
Run this, which will checkout the latest code & unpack the scripts into @/usr/local/bin@
