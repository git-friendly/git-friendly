...
Bonus niceties:
* *push* also copies a GitHub project URL to your clipboard for easy pasting
...
| *push* | Push your changes to the remote + copy a project URL like "http://github.com/jamiew/git-friendly/":http://github.com/jamiew/git-friendly/ to your clipboard (works on Mac and Linux) |
