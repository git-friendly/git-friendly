...
Git is super powerful but often forces you to type 2 or 3 commands just to do these basic tasks. This package adds *pull*, *push*, *branch* and *merge* commands which are just wrappers executing a few git commands & other callbacks
...
* all commands behave well: always use rebase, stash/pop things as needed, etc.
...
<img src="http://cl.ly/4e09/Screen_shot_2011-02-16_at_11.11.57_AM.png" alt="" title="Rolling in style" />
...
| *push* | pushes your changes to the remote and copies a sexy URL like "http://github.com/jamiew/myrepo/compare/3f9fea...fv932" to your clipboard. This only works on Macs, but boy is it sweet. |
| *branch [name]* | creates a new branch both locally & remotely, with remote tracking enabled (so you can just type 'git pull' and not 'git pull origin newbranch') |
| *merge* | merges your amazing new branch back into master using rebase. Remember: Always Be Rebasing. |
...
<img src="http://cl.ly/4dwB/Screen_shot_2011-02-16_at_11.55.37_AM.png" alt="" title="You could be this cool" />
