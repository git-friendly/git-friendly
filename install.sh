...
# Scripts to install
FILES=(commit branch merge pull push stash)
...
for s in ${FILES[*]}; do
  curl -sS -o ${dest}/${s} https://raw.githubusercontent.com/nicolasritouet/git-friendly/master/${s}
  if [ ! -f ${dest}/${s} ]; then
    echo
    ...
    echo "https://github.com/nicolasritouet/git-friendly#install"
    echo
    exit 1
  fi
  chmod +x ${dest}/${s}
...
echo "https://github.com/nicolasritouet/git-friendly"
echo
